...
# Function to perform hill climbing algorithm for goal state


def hill_climbing_goal(initial_state, goal_state):
    ...
    while not is_goal_state(current_state, goal_state):
        ...
        _, current_state = valid_neighbors.pop(0)
        current_distance = manhattan_distance(current_state, goal_state)
...
# Function to perform hill climbing algorithm for plateau


def hill_climbing_plateau(initial_state, goal_state):
    current_state = initial_state
    current_distance = manhattan_distance(current_state, goal_state)
    visited_states = set()
    temperature = 1.0
...
def main():
    ...
    hill_climbing_goal(initial_state, goal_state)
    hill_climbing_plateau(initial_state, goal_state)
